// features/budget/data/repositories/budget_repository_impl.dart
...
class BudgetRepositoryImpl implements BudgetRepository {
  ...
  Future<BudgetEntity?> getCurrentBudget(int userId) async {
    return await localDataSource.getCurrentBudget(userId);
  }

  @override
  Future<void> createBudget(BudgetEntity budget) async {
    await localDataSource.createBudget(BudgetModel.fromEntity(budget));
  }

  @override
  Future<void> updateBudget(BudgetEntity budget) async {
    await localDataSource.updateBudget(BudgetModel.fromEntity(budget));
  }
  ...
  Future<List<BudgetCategoryEntity>> getBudgetCategories(
    ...
    return await localDataSource.getBudgetCategories(budgetId);
  }

  @override
  Future<void> createBudgetCategory(BudgetCategoryEntity category) async {
    await localDataSource
        .createBudgetCategory(BudgetCategoryModel.fromEntity(category));
  }

  @override
  Future<void> updateBudgetCategory(BudgetCategoryEntity category) async {
    await localDataSource
        .updateBudgetCategory(BudgetCategoryModel.fromEntity(category));
  }
